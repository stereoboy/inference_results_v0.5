...
start=`date +%s`
cp -vf ./build/engines/${DEVICE}/ssd-small/SingleStream/ssd-small-${MODEL}-SingleStreamB1-gpu-b1-int8.plan ./build/engines/${DEVICE}/ssd-small/SingleStream/ssd-small-SingleStream-gpu-b1-int8.plan
...
start=`date +%s`
cp -vf ./build/engines/${DEVICE}/ssd-small/SingleStreamB2/ssd-small-${MODEL}-SingleStreamB2-gpu-b2-int8.plan ./build/engines/${DEVICE}/ssd-small/SingleStreamB2/ssd-small-SingleStreamB2-gpu-b2-int8.plan
...
start=`date +%s`
cp -vf ./build/engines/${DEVICE}/ssd-small/SingleStreamB4/ssd-small-${MODEL}-SingleStreamB4-gpu-b4-int8.plan ./build/engines/${DEVICE}/ssd-small/SingleStreamB4/ssd-small-SingleStreamB4-gpu-b4-int8.plan
...
start=`date +%s`
cp -vf ./build/engines/${DEVICE}/ssd-small/SingleStreamB8/ssd-small-${MODEL}-SingleStreamB8-gpu-b8-int8.plan ./build/engines/${DEVICE}/ssd-small/SingleStreamB8/ssd-small-SingleStreamB8-gpu-b8-int8.plan
