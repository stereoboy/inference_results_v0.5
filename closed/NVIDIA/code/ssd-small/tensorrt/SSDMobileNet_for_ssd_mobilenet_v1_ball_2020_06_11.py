...
class SSDMobileNet(BenchmarkBuilder):
    ...
    def __init__(self, args):
        ...
        # Model path
        self.model_path = dict_get(args, "model_path", default="build/models/frozen_model_ssd_mobilenet_v1_ball_2020_06_11/frozen_inference_graph.pb")
        ...
        if self.precision == "int8":
            ...
            cache_file = dict_get(self.args, "cache_file", default="code/ssd-small/tensorrt/calibrator_ssd_mobilenet_v1_ball_2020_06_11.cache")
    ...
    def initialize(self):
        ...
        uff_model = uff.from_tensorflow_frozen_model(self.model_path, preprocessor="code/ssd-small/tensorrt/SSDMobileNet_for_ssd_mobilenet_v1_ball_2020_06_11.py")
